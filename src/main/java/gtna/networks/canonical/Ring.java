...
/**
 * Implements the network generator for a ring network of given size. In a ring, every node has
 * exactly two undirected connection to its predecessor and successor in a logical ring, forming one
 * cycle.
 *
 * @author benni
 */
