...
/**
 * @author Andreas Höfer Create a Breath First Search (BFS) spanning tree with given root and
 *         restricted max degree (= max nr of children
 */
public class RestrictedBFSTree extends Transformation {
  ...
  /**
   * @param root      index of the root node of the ST; root = -1 => draw the root randomly; root =
   *                  -2 => root is one node of the one percent highest degree nodes
