...
public class Util {
  ...
  /**
   * Merges the two given String arrays. The elements of the second array are added after the
   * elements of the first array, the order inside the arrays is preserved. If the first array is
   * null, the second array is returned, if the second array is null, the first array is returned,
   * if both arrays are null, null is returned.
   *
   * @param arr1 The first array that is to be merged.
   * @param arr2 The second array that is to be merged.
   * @return A new String array of length arr1.length+arr2.length containing the elements of arr1
   *         and arr2.
   */
   ...
   *
   * @param prefix     The prefix to be attached to all values in the array.
   * @param parameters The array to which the prefix is to be attached.
  ...
  /**
   * Maps labels to communities. Labels are mapped in ascending order, communities are indexed from
   * 0 to N, where N is the number of communities.
   *
