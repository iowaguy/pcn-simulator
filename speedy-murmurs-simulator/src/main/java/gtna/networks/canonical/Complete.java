...
/**
 * Implements the network generator for a complete / fully-connected network of given size. In a
 * fully-connected network, every node has a connection to every other node.
 *
 * @author benni
 */
