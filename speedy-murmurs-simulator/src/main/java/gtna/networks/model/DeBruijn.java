...
/**
 * Implements a network generator for De Bruijn graph, a deterministic network topology with small
 * diameter despite low node degrees.
 * <p>
 * http://en.wikipedia.org/wiki/De_Bruijn_graph
 * <p>
 * Parameters are the base and the dimensions. This results in networks with base^{dimensions}
 * nodes.
 *
 * @author benni
 */
