...
/**
 * Implements the so-called Barabasi Albert network growth model described by Barabasi and Albert in
 * their publication "Emergence of scaling in random networks" (1999).
 * <p>
 * http://en.wikipedia.org/wiki/Barabasi–Albert_model
 * <p>
 * Parameters are the initial network size and the number of edges per added node.
 *
 * @author benni
 */
