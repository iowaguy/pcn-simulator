...
/**
 * Implements a graph generator for a list of snapshots. It works like the ReadableFile network
 * generator and simply takes a list of snapshots as parameter. Every time the generate method is
 * called, the next snapshot in the list is used. Therefore, LIST.length different graphs can be
 * generated with this implementation. Hence, if a series with more than LIST.length iterations is
 * generated, there will be duplicates in the "generated" network graphs.
 * <p>
 * The parameters are the list snapshot filename and the type (as defined by the GraphReader
 * class).
 *
 * @author benni
 */
