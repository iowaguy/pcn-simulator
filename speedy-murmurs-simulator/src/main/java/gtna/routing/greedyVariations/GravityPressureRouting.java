...
/**
 * GravityPressure Routing as described in 'Hyperbolic Embedding and Routing for Dynamic Graphs' by
...
public class GravityPressureRouting extends RoutingAlgorithm {
  ...
  /**
   * returns the index of next node as well the minimal distance to target of all nodes seen up to
   * that point
   */
