...
/**
 * @author Andreas Höfer Implementation of the prefix embedding algorithm as published in the paper:
 *         Höfer, Roos, Strufe: Greedy Embedding, Routing, and Content Addressing For Darknets,
 *         NetSys 2013
 *         <p>
 *         The spanning tree used for the embedding is passed in the SPANNINGTREE graph property.
 *         Please note that the bitsPerCoord property of the embedding defines an upper bound for
 *         the degree in the spanning tree
 */
public class PrefixEmbedding extends Transformation {
   ...
   *                     (2^bitsPerCoord is an upper limit for the nr of children of a node in the
   *                     spanning tree)
