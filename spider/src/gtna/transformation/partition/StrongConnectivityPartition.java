...
/**
 * @author benni uses the algorithm of Tarjan to compute the strongly connected components of the
 *         given graph http://en.wikipedia.org/wiki/Tarjan 's_strongly_connected_components_algorithm
 */
