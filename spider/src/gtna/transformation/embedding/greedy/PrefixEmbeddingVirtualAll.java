 ...
 *         <p>
 *         Implementation of the prefix embedding algorithm with virtual trees as published in the
 *         paper: Höfer, Roos, Strufe: Greedy Embedding, Routing, and Content Addressing For
 *         Darknets, NetSys 2013
 *         <p>
 *         gThe spanning tree used for the embedding is passed as SPANNINGTREE property of the
 *         graph. .
 */
public class PrefixEmbeddingVirtualAll extends Transformation {
  ...
  /**
   * @param bitsPerCoord maximum nr of bits per coordinate (2^bitsPerCoord is an upper limit for the
   *                     nr of children of a node); to achieve unlimited degree set bitsPerCoord to
   *                     Integer.MaxValue
   */
